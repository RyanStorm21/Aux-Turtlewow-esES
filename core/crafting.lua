...
do
    local function cost_label(cost)
        local label = LIGHTYELLOW_FONT_COLOR_CODE .. '(Costo Total: ' .. FONT_COLOR_CODE_CLOSE
        label = label .. (cost and money.to_string2(cost, nil, LIGHTYELLOW_FONT_COLOR_CODE) or GRAY_FONT_COLOR_CODE .. 'N/D' .. FONT_COLOR_CODE_CLOSE)
