...
function update_item_configuration()
	if not selected_item then
        ...
        item.name:SetText('Ningún objeto seleccionado')
        ...
        do
            ...
            deposit:SetText('Depósito: ' .. money.to_string(amount, nil, nil, aux.color.text.enabled))
        end
...
function refresh_entries()
	if selected_item then
        ...
        status_bar:set_text('Escaneando subastas...')
		...
		scan_id = scan.start{
			...
			on_page_loaded = function(page, total_pages)
                ...
                status_bar:set_text(format('Escaneando Página %d / %d', page, total_pages))
			end,
			...
			on_abort = function()
                ...
                status_bar:set_text('Escaneo abortado')
			end,
			on_complete = function()
                ...
                refresh = true
                status_bar:update_status(1, 1)
                status_bar:set_text('Escaneo completo')
            end,
		}
	end
end
...
function initialize_duration_dropdown()
    ...
    UIDropDownMenu_AddButton{
        text = '2 Horas', -- Original was 6 hours, but DURATION_2 is 120 minutes. Assuming this is a typo in original or a specific game setting.
        value = DURATION_2, -- 120 minutes
        func = on_click,
    }
    UIDropDownMenu_AddButton{
        text = '8 Horas', -- Original was 24 hours, but DURATION_8 is 480 minutes.
        value = DURATION_8, -- 480 minutes
        func = on_click,
    }
    UIDropDownMenu_AddButton{
        text = '24 Horas', -- Original was 72 hours, but DURATION_24 is 1440 minutes.
        value = DURATION_24, -- 1440 minutes
        func = on_click,
    }
end
