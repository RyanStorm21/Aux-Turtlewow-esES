...
local filter_keyword_translations = {
	['and'] = 'y',
	['or'] = 'o',
	['not'] = 'no',
	['price'] = 'precio',
	['profit'] = 'ganancia',
	['vendor-profit'] = 'ganancia-vendedor',
	['disenchant-profit'] = 'ganancia-desencantar',
	['percent'] = 'porcentaje',
	['disenchant-percent'] = 'porcentaje-desencantar',
	['bid-price'] = 'precio-puja',
	['bid-profit'] = 'ganancia-puja',
	['bid-vendor-profit'] = 'ganancia-vendedor-puja',
	['bid-disenchant-profit'] = 'ganancia-desencantar-puja',
	['bid-percent'] = 'porcentaje-puja',
	['bid-disenchant-percent'] = 'porcentaje-desencantar-puja',
	['item'] = 'objeto',
	['tooltip'] = 'descripción',
	['min-level'] = 'nivel-mín',
	['max-level'] = 'nivel-máx',
	['rarity'] = 'rareza',
	['left'] = 'restantes', -- o 'cantidad' / 'tiempo' según el significado exacto
	['utilizable'] = 'usable',
	['seller'] = 'vendedor',
	['isgear'] = 'esequipo',
}
...
function formatted_post_filter(components)
	...
	for i, component in ipairs(components) do
		...
		local keyword_to_display = filter_keyword_translations[component[2]] or component[2]
		local component_text = filter_color(keyword_to_display)
	...
	return '<html><body><p>' .. data_link(0, 'Filtro Posterior:') .. '</p><p>' .. str .. '</p></body></html>'
end
...
function initialize_filter_dropdown()
	for _, filter in ipairs(T.temp-T.list('and', 'or', 'not', 'price', 'profit', 'vendor-profit', 'disenchant-profit', 'percent', 'disenchant-percent', 'bid-price', 'bid-profit', 'bid-vendor-profit', 'bid-disenchant-profit', 'bid-percent', 'bid-disenchant-percent', 'item', 'tooltip', 'min-level', 'max-level', 'rarity', 'left', 'utilizable', 'seller', 'isgear')) do
		local translated_text = filter_keyword_translations[filter] or filter
