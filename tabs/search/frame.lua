...
do
	...
	btn:SetHeight(25)
	btn:SetWidth(60)
	btn:SetText(aux.color.label.enabled'Rango:')
...
do
	...
	btn:SetWidth(60)
	btn:Hide()
	btn:SetText(aux.color.label.enabled'Tiempo Real')
	btn:SetScript('OnClick', function()
...
do
    ...
    btn:SetWidth(243)
    btn:SetHeight(22)
    btn:SetText('Resultados de Búsqueda')
...
do
    ...
    btn:SetWidth(243)
    btn:SetHeight(22)
    btn:SetText('Búsquedas Guardadas')
...
do
    ...
    btn:SetWidth(243)
    btn:SetHeight(22)
    btn:SetText('Creador de Filtros')
...
do
    ...
    local label = gui.label(dropdown, gui.font_size.small)
    label:SetPoint('BOTTOMLEFT', dropdown, 'TOPLEFT', -2, -3)
    label:SetText('Subclase de Objeto')
...
do
    ...
    local label = gui.label(dropdown, gui.font_size.small)
    label:SetPoint('BOTTOMLEFT', dropdown, 'TOPLEFT', -2, -3)
    label:SetText('Ranura de Objeto')
...
favorite_searches_listing:SetColInfo{{name='Auto', width=.07, align='CENTER'}, {name='Búsquedas Favoritas', width=.93}}

recent_searches_listing = listing.new(frame.saved.recent)
recent_searches_listing:SetColInfo{{name='Búsquedas Recientes', width=1}}
